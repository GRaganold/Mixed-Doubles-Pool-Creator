  ...
  return (
    <>
      ...
      <p className="instruction">
        {" "}
        Enter the number of teams in your event and the of pools{" "}
      </p>
      <div
        style={{
          display: "flex",
      ...
      {numTeams !== null && numPools !== null && (
        <>
          <div>
            ...
            <p className="instruction">
              For each input, enter the team name. A dropdown will appear to
              help you auto-complete and select the team. Once selected, the
              team will be added to the list below.
            </p>
            {/* Dynamic team inputs */}
                  ...
                  >
                    {suggestions[index].map((name, i) => (
                      <li
                        ...
                        style={{
                          padding: "8px 12px",
                          cursor: inputValues.includes(name)
                            ? "not-allowed"
                            : "pointer", // Disable the pointer if the name is in inputValues
                          backgroundColor: inputValues.includes(name)
                            ? "#f0f0f0"
                            : "#fff", // Change the background to a light gray if disabled
                          borderBottom: "1px solid #eee",
                          transition: "background 0.2s",
                          opacity: inputValues.includes(name) ? 0.5 : 1, // Make it appear faded if disabled
                        }}
                        onMouseEnter={(e) =>
                          !inputValues.includes(name) &&
                          (e.currentTarget.style.backgroundColor = "#007bff")
                        } // Blue background on hover, only if not disabled
                        onMouseLeave={(e) =>
                          !inputValues.includes(name) &&
                          (e.currentTarget.style.backgroundColor = "#fff")
                        } // Reset if not disabled
                      >
                        {name}
                      </li>
                    ))}
            ...
            <p className="instruction">
              The teams entered above will be ranked based on the selected
              week's world rankings. You can add or subtract points as
              needed—use a one (1) point adjustment to break ties. Teams will
              then be snake-ordered into the selected number of pools.
            </p>
            ...
            >
              ...
              <small>
                {" "}
                If you need to adjust a team's total, you can either use the
                arrows in the input field or manually enter the new amount. Once
                you're satisfied with the change, click the 'Submit' button to
                save it. If you wish to reset the team's total, simply click the
                'Reset' button, and it will return the total to the value for
                the selected week.
              </small>
              {inputValues
                .map((name) => {
                ...
                .sort((a, b) => {
                  ...
                  const totalA =
                    a["TOTAL"] === "Unranked" ? -1 : Number(a["TOTAL"]);
                  const totalB =
                    b["TOTAL"] === "Unranked" ? -1 : Number(b["TOTAL"]);
                ...
                .map((row, index) => (
                  ...
                  >
                    ...
                    >
                      ...
                      <button
                        onClick={() => {
                          // Reset the local input value to the original TOTAL
                          setInputTotals((prev) => ({
                            ...prev,
                            [row.Team]: row.TOTAL,
                          }));
              ...
              >
                ...
                {(() => {
                  ...
                  const isDownloadDisabled =
                    ...
                    inputValues.some((name) => !name || name.trim() === "");
